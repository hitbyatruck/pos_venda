"""
Django settings for pos_venda project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'testserver', '192.168.1.119']
...
WSGI_APPLICATION = 'pos_venda.wsgi.application'
...
# Default language
LANGUAGE_CODE = 'pt'  # Change if your default should be different
...
LOGIN_URL = '/accounts/login/'  # URL para onde redirecionar quando @login_required falhar
