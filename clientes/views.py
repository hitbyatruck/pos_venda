...
def excluir_cliente(request, cliente_id):
    """
    Exclui um cliente e seus equipamentos associados.
    """
    cliente = get_object_or_404(Cliente, id=cliente_id)
    ...
    try:
        ...
        return JsonResponse({"success": False, "message": f"Erro ao excluir cliente: {str(e)}"})
...
def desassociar_equipamento(request, equipamento_cliente_id):
    """
    Desassocia um equipamento de um cliente.
    """
    ...
    try:
        ...
        return JsonResponse({"success": False, "message": f"Erro ao desassociar equipamento: {str(e)}"})