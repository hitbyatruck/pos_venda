...
urlpatterns = [
    ...
    path('categorias/bulk/', views.bulk_categorias, name='bulk_categorias'),  # New endpoint for bulk actions
    ...
    # Add this new endpoint for serial number search
    path('api/serial/<str:numero_serie>/', views.api_equipamento_by_serial, name='api_equipamento_by_serial'),
